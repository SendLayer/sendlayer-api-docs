...
| `cc` | `array` | No | Array of objects containing CC recipient email addresses and names |
| `bcc` | `array` | No | Array of objects containing BCC recipient email addresses and names |
| `replyTo` | `array` | No | Array of objects containing reply-to email addresses and names |
