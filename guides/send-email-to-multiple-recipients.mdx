...
description: 'Learn how to send emails to multiple recipients using the SendLayer API'
icon: 'users'
keywords: ['send email to multiple recipients', 'sendlayer', 'email', 'multiple recipients', 'sdk']
---
...
<AccordionGroup>
  <Accordion title="What is the maximum number of recipients I can send to?">
    ...
    For more information, see our [Rate Limits](/api-reference/rate-limit) documentation.
  </Accordion>
