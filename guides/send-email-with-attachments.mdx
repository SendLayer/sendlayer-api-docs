...
$params = [
  ...
  'html' => '<html><body><h1>Please find the attached document</h1><p>I have attached the requested PDF file for your review.</p></body></html>',
  'attachments' => [
    [ 'path' => './path/to/document.pdf', 'type' => 'application/pdf' ]
  ]
];
...
resp, err := sl.Emails.Send(
  ...
  "Document Attachment",
  "",
  "<html><body><h1>Please find the attached document</h1><p>I have attached the requested PDF file for your review.</p></body></html>",
  nil, nil, nil,
  []sendlayer.Attachment{{Path: "./path/to/document.pdf", Type: "application/pdf"}},
  nil, nil,
)
```
...
$params = [
  ...
  'attachments' => [
    [ 'path' => './path/to/document.pdf', 'type' => 'application/pdf' ],
    [ 'path' => './path/to/image.jpg', 'type' => 'image/jpeg' ]
  ]
];
```
...
$params = [
  ...
  'html' => '<html><body><h1>Files from different sources</h1><p>Attaching both local and remote files.</p></body></html>',
  'attachments' => [
    [ 'path' => './local-document.pdf', 'type' => 'application/pdf' ],
    [ 'path' => 'https://example.com/remote-image.jpg', 'type' => 'image/jpeg' ]
  ]
];
```
