---
title: 'Quickstart'
description: 'Learn how to quickly setup and use SendLayer email API to send transactional emails'
icon: 'rocket'
---

## Prerequisites

Before you can use the SendLayer API, you'll need to [authorize your sending domain](https://sendlayer.com/docs/authorizing-your-domain/). This is an important step as it proves domain ownership and improves email deliverability.
